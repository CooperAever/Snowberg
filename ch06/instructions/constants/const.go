...
// push null into operandStack
func (self *ACONST_NULL) Execute(frame *rtda.Frame){
	frame.OperandStack().PushRef(nil)
}

// push double value into operandStack
...
// push float value into operandStack
...
// push int value into operandStack
...
// push long value into operandStack
