...
// newarray instruction need two operand
// first operand is atype, means new which type of array
...
// second operand is count, pop from operandStack,means array length
